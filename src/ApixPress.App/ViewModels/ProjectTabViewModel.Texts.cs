...
{
    private static class ProjectSettingsTexts
    {
    ...
    private static class ImportTexts
    {
    ...
    public string ImportedApiDocumentSummaryText => ProjectSettingsTexts.FormatImportedApiDocumentSummary(ImportedApiDocuments.Count);
    ...
    public string ImportDialogTitle => ImportTexts.DialogTitle;
    public string ImportDialogFormatLabel => ImportTexts.DataSourceFormatLabel;
    public string ImportDialogFormatName => ImportTexts.DataSourceFormatName;
    public string ImportDialogNoticeText => ImportTexts.DialogNotice;
    public string ImportFileModeTitle => ImportTexts.FileModeTitle;
    public string ImportUrlModeTitle => ImportTexts.UrlModeTitle;
    public string ImportPickFileButtonText => ImportTexts.PickFileButton;
    public string ImportStartButtonText => ImportTexts.StartImportButton;
    public string ImportUrlDescription => ImportTexts.UrlDescription;
    public string ImportUrlWatermark => ImportTexts.UrlWatermark;
    public string ImportUrlButtonText => ImportTexts.ImportUrlButton;
    public string ImportBusyOverlayDescription => ImportTexts.BusyOverlayDescription;
}
